...
int main () 
{
    ...
    int i, i2, i1;
    for(i1 = 0; i1 <= quantNumeros - 2; i1++) //mudar Variavel e completar.
    {
        Cofre[i1][0] = 0; 
    ...
    for(i = 0; i <= quantTestes - 2; i++) //mudar Variavel e completar.
    {
        scanf ("%d", &aTestes[i]);
        if (i >= 1)
        {
            ...
            {
                for(i2 = aTestes[i - 1] - 2; i2 >= aTestes[i] - 1; i2--) //mudar Variavel e completar.
                {
                    Cofre[i2][1] += 1;
                    printf ("%d a\n",Cofre[i2][1]);
                }
            ...
            {
                for(i2 = aTestes[i - 1]; i2 <= aTestes[i] - 1; i2++) //mudar Variavel e completar.
                {
                    Cofre[i2][1] += 1;
                    printf ("%d b\n",Cofre[i2][1]);
                }
    ...
    for(i = 0; i <= 9; i++) //mudar Variavel e completar.
    {
        CofreOrganizado[i][0] = i;
        CofreOrganizado[i][1] = 0;
        //printf (" %d ", CofreOrganizado[i][0]);
        for(i2 = 0; i2 <= quantNumeros - 2; i2++) //mudar Variavel e completar.
        {
